...
let brActive = "translateX(-5vw) translateY(0vh)";
    ...
    switch(activeCorner){
        case "top-left" :
            if(window.innerWidth <= 1100){
                ...
                tlBtn.style.justifyContent = "300";
                trBtn.style.justifyContent = "100";
                blBtn.style.justifyContent = "100";
                brBtn.style.justifyContent = "100";
            } else {
                tlActive = "translateX(8vw) translateY(0)";
                tlContent.style.transform = "translateX(8vw) translateY(0)";
        ...
        case "top-right" :
            if(window.innerWidth <= 1100){
                ...
                tlBtn.style.justifyContent = "100";
                trBtn.style.justifyContent = "300";
                blBtn.style.justifyContent = "100";
                brBtn.style.justifyContent = "100";
            } else {
        ...
        case "bottom-left" :
            if(window.innerWidth <= 600){
                ...
                tlBtn.style.justifyContent = "100";
                trBtn.style.justifyContent = "100";
                blBtn.style.justifyContent = "300";
                brBtn.style.justifyContent = "100";
        ...
        if(window.innerWidth <= 1100){
            ...
            trBtn.style.justifyContent = "100";
            blBtn.style.justifyContent = "100";
            brBtn.style.justifyContent = "300";
        } else {
...
//Store last reverse animtation, ready to be played
let lastReverseAnimation = "";

// Play animation function

function playAnimation(animation, reverseAnimation){
    // Remove all the animation classList from the heroImage
    heroImage.className = "";
    if(lastReverseAnimation !== ""){
        // Clicked something -> reverseAnimation
        ...
        // Have not click -> forwardAnimation
        heroImage.classList.add(animation);
        lastReverseAnimation = reverseAnimation;
    }
}
